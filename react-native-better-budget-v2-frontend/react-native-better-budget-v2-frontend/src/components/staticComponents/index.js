  ...
  return (
    <Wrappers.Wrapper style={{ borderBottomWidth: 1, borderBottomColor: bottomWidth ? bottomWidth : colors.lightRed }}>
      <Wrappers.RowBasic style={{ marginHorizontal: width(3), marginBottom: totalSize(1.3) }}>
        ...
        <Texts.SmallText style={{ ...styles.heading, width: width(20), textAlign: 'center' }}>{Translate('dueDate')}</Texts.SmallText>
...
export const ExpenseHeaderHome = ({ borderColor }) => {
  return (
    <Wrappers.Wrapper style={{ borderBottomWidth: 1, borderBottomColor: borderColor ? borderColor : colors.lightRed }}>
      <Wrappers.Component>
        <Wrappers.RowBasic style={{ marginBottom: totalSize(1.3), marginRight: width(6) }}>
          <Texts.SmallText style={{ ...styles.heading, width: width(32) }}>{Translate('Expenses')}</Texts.SmallText>
          <Texts.SmallText style={{ ...styles.heading, width: width(28), textAlign: 'center' }}>{Translate('dueDate')}</Texts.SmallText>
          <Texts.SmallText style={{ ...styles.heading, width: width(28), textAlign: 'right' }}>{Translate('Amount')}</Texts.SmallText>
        </Wrappers.RowBasic>
      </Wrappers.Component>
    </Wrappers.Wrapper>
  )
  ...
  return (
    <Wrappers.Wrapper style={{ borderBottomWidth: 1, borderBottomColor: borderColor ? borderColor : colors.lightRed }}>
      <Wrappers.RowBasic style={{ marginHorizontal: width(3), marginBottom: totalSize(1.3) }}>
        ...
        <Texts.SmallText style={{ ...styles.heading, width: width(30), textAlign: 'center' }}>{Translate('Payment')}</Texts.SmallText>
        <Wrappers.Wrapper>
          <Texts.SmallText style={{ ...styles.heading, width: width(32), textAlign: 'right' }}>{Translate('MyBudgetScreen.debtTotal')}</Texts.SmallText>
