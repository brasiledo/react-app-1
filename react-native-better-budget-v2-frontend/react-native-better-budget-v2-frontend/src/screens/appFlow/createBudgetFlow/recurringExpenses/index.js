...
const AddRecurringExpenses = ({ navigation, route }) => {
    ...
    const onPressCountinue = () => {
        let budgetDetail = { ...item, Income: debtsSingle ?? debtsMultiple, Expenses: expenses }
    ...
    const onPressAdd = () => {
        ...
        let data = {
            ...
            firstBillDue: firstBillDue ? Date.parse(Date(firstBillDue)) : '-',
            nextBillDue: nextBillDue ? Date.parse(Date(nextBillDue)) : '-',
        }
    ...
    return (
        <Wrappers.Wrapper style={styles.wrapper}>
                ...
                <CopilotStep text={ToolTiopsText.text11} order={10} name="expenseName">
                    <CopilotView>
                        <TextInputs.TextInputLowerBordered
                            ...
                            value={expenseName}
                            onChangeText={en => setExpenseName(en)}
                            ...
                            onPressMenuIcon={() => setModalExpensesCategoriesVisible(!isModalExpensesCategoriesVisible)}
                            onBlur={() => setModalExpensesCategoriesVisible(!isModalExpensesCategoriesVisible)}
                        />
                    </CopilotView>
                </CopilotStep>
                <Spacers.Base />
                ...
                {expenseFrequency !== 'Every Pay Cycle' &&
                    <>
                        {expenseFrequency == 'Twice a Month' &&
                            <TouchableOpacity
                                activeOpacity={1}
                                onPress={() => setModalFirstDateVisible(!isModalFirstDateVisible)}>
                                <TextInputs.TextInputLowerBorder
                        ...
                        <Wrappers.Wrapper>
                            <TouchableOpacity
                                activeOpacity={1}
                                onPress={() => setModalNextDateVisible(!isModalNextDateVisible)}>
            ...
            <Modals.ExpensesModal
                ...
                expenses={expenses}
                onPressAddExpenses={() => { setModalExpensesVisible(!isModalExpensesVisible) }}
