...
const sizes = {
  ...
  marginHorizontal1: width*0.025,
  marginVertical: height*0.025,
  section: 25,
  modalMargin: totalSize(0.2),
  ...
  buttonRadius: (Platform.OS === 'ios') ? 30 : 40,
  modalRadius: 15,
  cardRadius: 15,
  ModalRadius: 25,
  inputRadius:(Platform.OS === 'ios') ? 40 : 40,
  multiRadius:(Platform.OS === 'ios') ? 5 : 10,
