...
import { Animated, PanResponder, Pressable, ScrollView, StyleSheet, TouchableOpacity, View } from 'react-native';
...
export const ShowDebts = ({ onPress, DebtsName, DebtsAmount, Drag, editButton, checked, onValueChange, index, currentlyOpenIndex,
...
const SwipableItem = ({ onPress, DebtName, DebtAmount, editButton, checked, onValueChange, index, currentlyOpenIndex,
    setCurrentlyOpenIndex, Currency, toolTip, user, onPressDelete }) => {
                    ...
                    <Wrappers.Wrapper>
                        ...
                        <Wrappers.Wrapper style={{ marginHorizontal: width(3), marginVertical: totalSize(1.3), flexDirection: 'row' }}>
                            <Wrappers.RowBasic>
                                ...
                                <Texts.SmallText numberOfLines={1} style={{ ...styles.expenseDetail, width: editButton ? width(48) : width(50), marginLeft: editButton ? width(2) : 0 }}>{DebtName}</Texts.SmallText>
                            </Wrappers.RowBasic>
                            <Texts.SmallText style={{ ...styles.expenseDetail, width: width(45), textAlign: 'right' }}>{selectedCurrencySymbol(Currency)} {DebtAmount}</Texts.SmallText>
                        </Wrappers.Wrapper>
                    </Wrappers.Wrapper>
                            ...
                            <CopilotView>
                                ...
                                <Wrappers.Wrapper style={{ marginHorizontal: width(3), marginVertical: totalSize(1.3), flexDirection: 'row' }}>
                                    <Wrappers.RowBasic>
                                        ...
                                        <Texts.SmallText numberOfLines={2} style={{ ...styles.expenseDetail, width: editButton ? width(48) : width(50), marginLeft: editButton ? width(2) : 0 }}>{DebtName}</Texts.SmallText>
                                    </Wrappers.RowBasic>
                                    <Texts.SmallText style={{ ...styles.expenseDetail, width: width(45), textAlign: 'right' }}>{selectedCurrencySymbol(Currency)} {DebtAmount}</Texts.SmallText>
                                </Wrappers.Wrapper>
                            </CopilotView>
