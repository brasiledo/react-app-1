...
const AppNavigation = () => {
  return (
    <AppStack.Navigator
      ...
      <AppStack.Screen name={routes.oneTimeExpense} component={App.OneTimeExpense} />
      <AppStack.Screen name={routes.addRecurringExpenses} component={App.AddRecurringExpenses} />
      <AppStack.Screen name={routes.simulatedExpense} component={App.SimulatedExpenses} />
      <AppStack.Screen name={routes.simulatedBudget} component={App.SimulatedBudget} />
          ...
          tabBarIcon: ({ focused }) => {
            return (
              <>
                ...
                <Spacers.Tiny />
                <Home
                  color={focused ? colors.placeholderColor : colors.mediumDark}
                />
                <Spacers.Tiny />
              </>
            );
